...
if redis:get(nk..":ZhrfNow:"..msg.sender_user_id_) then
redis:del(nk..":ZhrfNow:"..msg.sender_user_id_)
...
if msg.text and msg.type ~= "pv" and redis:get(nk..":ZhrfNow:"..msg.sender_user_id_) then
Text = msg.text
redis:del(nk..":ZhrfNow:"..msg.sender_user_id_)
if utf8.len(msg.text) > 300 then
